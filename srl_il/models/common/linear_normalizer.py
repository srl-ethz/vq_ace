...
class LinearNormalizer(DictOfTensorMixin):
    def __init__(self, offset, scale):
        super().__init__()
        self.params_dict['offset'] = nn.Parameter(offset)
        self.params_dict['scale'] = nn.Parameter(scale)
        self.params_dict.requires_grad_(False)

    def normalize(self, x):
        return (x-self.params_dict['offset']) / self.params_dict['scale']
    
    def denormalize(self, x):
        return x * self.params_dict['scale'] + self.params_dict['offset']
